...
Frame Container
-------------------------------------------------------------------------------]]
local Type, Version = "TritonFrame", 26
...
local methods = {
  ...
  ["OnPowerButtonStatus"] = function(self, isactive)
    if isactive then
      self.powerbutton:SetNormalTexture("Interface\\AddOns\\Triton\\Media\\on")
      self.powerbutton:SetHighlightTexture("Interface\\AddOns\\Triton\\Media\\on")
      self.powerbutton:SetPushedTexture("Interface\\AddOns\\Triton\\Media\\on")
    else
      self.powerbutton:SetNormalTexture("Interface\\AddOns\\Triton\\Media\\off")
      self.powerbutton:SetHighlightTexture("Interface\\AddOns\\Triton\\Media\\off")
      self.powerbutton:SetPushedTexture("Interface\\AddOns\\Triton\\Media\\off")
    end
  end,
...
local function Constructor()
	...
	settingsbutton:SetNormalTexture("Interface\\AddOns\\Triton\\Media\\options")
	settingsbutton:SetHighlightTexture("Interface\\AddOns\\Triton\\Media\\options")
	settingsbutton:SetPushedTexture("Interface\\AddOns\\Triton\\Media\\options")

	local powerbutton = CreateFrame("Button", nil, frame)
	powerbutton:SetSize(11, 11)
	powerbutton:SetPoint("TOPLEFT", 15+5, -5)
	powerbutton:SetScript("OnClick", ButtonPower_OnClick)
	powerbutton:SetNormalTexture("Interface\\AddOns\\Triton\\Media\\on")
	powerbutton:SetHighlightTexture("Interface\\AddOns\\Triton\\Media\\on")
	powerbutton:SetPushedTexture("Interface\\AddOns\\Triton\\Media\\on")
