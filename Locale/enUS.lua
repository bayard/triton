...
L["AUTHOR_INFO"] = 'Hint: When entering keywords, using comma (|cff00cccc.|r) to seperate keywords. |cff00cccc&|r can be used as "|cff00ccccand|r" operator, |cff00cccc-|r can be used a "|cff00ccccnot|r" operator. Special class keyword：|cff00ccccclass:warlock|r refer to warlock, etc. Sender name can be used in search and case ignored. Aliases supported.\n\n' ..
'For Example:\n' .. 
...
'alias:keyword1,keyword2-excludekeyword: will show |cff00ccccalias|r prefix in filter menu instead of matching |cff00cccckeyword1|r or |cff00cccckeyword2-excludekeyword|r' ..
